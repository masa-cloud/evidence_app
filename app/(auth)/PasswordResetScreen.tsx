...
export type PasswordResetScreenNavigationProps = NativeStackNavigationProp<HomeTabParamList, 'PasswordResetScreen'>;

type Props = {
  navigation: PasswordResetScreenNavigationProps;
};

export default function PasswordResetScreen(props: Props): JSX.Element {
